...
def get_north_finance_change(
    ...
    return _call_xtdata_optional(xtdata, "get_north_finance_change", period)
...
def get_hkt_statistics(
    ...
    return _call_xtdata_optional(xtdata, "get_hkt_statistics", stock)
...
def get_hkt_details(
    ...
    return _call_xtdata_optional(xtdata, "get_hkt_details", stock)
